...
<div class="comment-respond">
    ...
    <form id="registerCommentForm" class="comment-form" method="post" action="{{route('blog.register_comment',\Vinkla\Hashids\Facades\Hashids::encode($post['id']))}}">
        ...
        <p class="comment-form-comment">
            ...
            <textarea class="@error('message') is-invalid
                                           @enderror" onkeyup="this.value=removeSpaces(this.value)"
                      autocomplete="message" autofocus name="message"
                      id="message" cols="45" rows="5"
                      maxlength="100000">{{old('message')}}</textarea>
        ...
        <p class="comment-form-email">
            ...
            <input value="{{old('email')}}" onkeyup="this.value=removeSpaces(this.value)" autocomplete="email" autofocus
        ...
        <p class="comment-form-author">
            ...
            <input value="{{old('name')}}" onkeyup="this.value=removeSpaces(this.value)" autocomplete="name" autofocus
        ...
        <p class="comment-form-author">
            ...
            <input value="{{old('mobile')}}" onkeyup="this.value=removeSpaces(this.value)" autocomplete="mobile"
                   autofocus
