                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="my-active"
                                                       href="{{route('team.edit',$team->id)}}">ویرایش
                                عضو تیم ({{$team->name}})</a></li>
                    </ol>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-success">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">ویرایش عضو تیم ({{$team->name}})</h3>
                        </div>

                        <form id="update_team_form" action="{{route('team.update',$team->id)}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('job',$team->job) }}" id="job" name="job"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('telegram',$team->telegram) }}" id="telegram" name="telegram"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('instagram',$team->instagram) }}" id="instagram"
                                           name="instagram"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('linkedin',$team->linkedin) }}" id="linkedin" name="linkedin"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('facebook',$team->facebook) }}" id="facebook" name="facebook"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('twitter',$team->twitter) }}" id="twitter" name="twitter"
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('email',$team->email) }}" id="email" name="email"
