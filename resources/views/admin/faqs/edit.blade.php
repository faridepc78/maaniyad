                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="my-active"
                                                       href="{{route('faqs.edit',$faq->id)}}">ویرایش
                                سوال ({{$faq->name}})</a></li>
                    </ol>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-success">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">ویرایش سوال ({{$faq->name}})</h3>
                        </div>

                        <form id="update_faq_form" action="{{route('faqs.update',$faq->id)}}"
                              method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('name',$faq['name']) }}" id="name" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" style="resize: vertical"
                                              ...
                                              name="value" autocomplete="value" autofocus>{{ old('value',$faq['value']) }}</textarea>
