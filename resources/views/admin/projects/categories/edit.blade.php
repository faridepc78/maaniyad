                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="my-active"
                                                       href="{{route('projects_categories.edit',$category->id)}}">ویرایش
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-success">
                        ...
                        <form id="update_project_category_form" action="{{route('projects_categories.update',$category->id)}}"
                              method="post">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#update_project_category_form').validate({
