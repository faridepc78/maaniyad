            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="my-active" href="{{route('feedbacks.create')}}">ایجاد
                                نظرات مشتریان</a></li>
                    </ol>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">ایجاد نظرات مشتریان</h3>
                        </div>

                        <form id="store_feedback_form" action="{{route('feedbacks.store')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea onkeyup="this.value=removeSpaces(this.value)"
                                              placeholder="لطفا نظر مشتری را وارد کنید" rows="5"
