@section('admin_title')
    <title>پنل مدیریت مانیاد | دسته بندی محصولات</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('posts_categories.index')}}">مدیریت دسته بندی ها</a></li>
                        <li class="breadcrumb-item"><a class="my-active" href="{{route('posts_categories.create')}}">ایجاد
                                دسته بندی ها</a></li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <form id="store_category_form" action="{{route('posts_categories.store')}}"
                              method="post">
