            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('products.comments.index')}}">مدیریت نظرات</a></li>
                        <li class="breadcrumb-item"><a class="my-active"
                                                       href="{{route('products.comments.single',$comment->id)}}">مدیریت
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-success">
                        ...
                        <form id="managementProductCommentForm" method="post"
                              action="{{route('products.comments.management',$comment['id'])}}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control  @error('status') is-invalid @enderror"
                                            ...
                                            @foreach(\App\Models\ProductComment::$statuses as $value)
                                                @if ($value!=\App\Models\ProductComment::PENDING)
                                                    <option
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#managementProductCommentForm').validate({
