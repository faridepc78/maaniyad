@section('admin_title')
    <title>پنل مدیریت مانیاد | نظرات محصولات</title>
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class="my-active" href="{{route('products.comments.index')}}">مدیریت
                                نظرات محصولات</a></li>
                    </ol>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-3">مدیریت نظرات محصولات</h3>

                            <div class="card-tools">
                                <form id="filterForm" method="get" action="{{route('products.comments.index')}}">
                            ...
                            <a href="{{route('products.comments.index',['answer=yes'])}}"
                               class="btn btn-success">جواب داده شده</a>

                            <a href="{{route('products.comments.index',['answer=no'])}}"
                               class="btn btn-danger">جواب داده نشده</a>

                            <br><br>

                            <a href="{{route('products.comments.index',['status='.\App\Models\ProductComment::ACTIVE])}}"
                               class="btn btn-success">@lang(\App\Models\ProductComment::ACTIVE)</a>

                            <a href="{{route('products.comments.index',['status='.\App\Models\ProductComment::INACTIVE])}}"
                               class="btn btn-danger">@lang(\App\Models\ProductComment::INACTIVE)</a>
                        </div>
                                    ...
                                    @foreach($comments as $key=>$value)
                                        ...
                                        @if ($value->status!=\App\Models\ProductComment::PENDING)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank"
                                                       href="{{route('products.comments.single',$value->id)}}">
