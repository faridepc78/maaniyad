            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class="my-active" href="{{route('agencies.index')}}">مدیریت
                                درخواست ها</a></li>
                    </ol>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-3">مدیریت درخواست ها</h3>

                            <div class="card-tools">
                                <form id="filterForm" method="get"
                                      action="{{route('agencies.index')}}">
                            ...
                            <a href="{{route('agencies.index','type='.\App\Models\Agency::READ)}}"
                               class="btn btn-success">خوانده شده</a>

                            <a href="{{route('agencies.index','type='.\App\Models\Agency::UNREAD)}}"
                                ...
                                @if(count($agencies))
                                    ...
                                    @foreach($agencies as $key=>$value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="{{route('agencies.single',$value->id)}}">
...
<script type="text/javascript">
    ...
    $('#filterForm').on('submit', function (e) {
        ...
        var route = "{{route('agencies.index')}}";
