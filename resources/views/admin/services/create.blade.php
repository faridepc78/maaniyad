            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a class="my-active" href="{{route('services.create')}}">ایجاد
                                خدمات</a></li>
                    </ol>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">ایجاد خدمات</h3>
                        </div>

                        <form id="store_service_form" action="{{route('services.store')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea onkeyup="this.value=removeSpaces(this.value)" placeholder="لطفا بیو خدمت را وارد کنید" rows="5" style="resize: vertical"
    ...
    $(document).ready(function () {
        ...
        $('#store_service_form').validate({
            ...
            messages: {
                ...
                image: {
                    required: "لطفا تصویر خدمت را انتخاب کنید"
                }
            },
